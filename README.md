# Projeto criação de uma lista de produtos, com paginação e barra da busca, focando em melhorar a experiência de uso.

**Objetivo:** Adicionar uma busca inteligente que usa a técnica Debounce (React) para evitar travar o servidor com muitas requisições e criar uma paginação dinâmica para navegar pelos produtos sem recarregar a tela.
...
1. Clonar o repositório:
   ...
   ```sh
   git clone https://github.com/RafaelaBiaze/DevWebFront09
   ```
